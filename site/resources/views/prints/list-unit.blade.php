...
@if($completeUnits)
    @foreach($units as $unit)
        <div class="panel panel-default rtl">
            <div class="panel-heading">{{$unit->title}}</div>
...
@else
    <table class="table table-hover">
        <thead>
            <th class="rtl text-center">عنوان واحد</th>
            <th class="rtl text-center">مدیریت</th>
            <th class="rtl text-center">شهر</th>
            <th class="rtl text-center">شماره تماس</th>
            <th class="rtl text-center">تعداد کارکنان</th>
            </thead>
            <tbody>
            @foreach ($units as $unit)
                <tr>
                    <td class="rtl text-center">{{$unit->title}}</td>
                    <td class="rtl text-center">{{$unit->manager_title}}</td>
                    <td class="rtl text-center">{{$habitate[$unit->city]}}</td>
                    <td class="rtl text-center">{{$unit->phone}}</td>
                    <td class="rtl text-center">{{sizeof($unit->employees)}}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
