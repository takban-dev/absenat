...
<div class="card rtl">
    <div class="card-header" data-background-color="purple">
        <h4 class="title">لیست شاغلین به تفکیک جنسیت و عنوان شغلی</h4>
    </div>
            ...
            <form action="{{url('admin/reports/genders-field-list')}}" method="get">
                ...
                <div class="col-md-8 col-sm-8 pull-right">
                    <div class="col-md-9 col-sm-12">
                        <div class="form-group label-floating rtl col-lg-12 col-md-12">
                            <input type="text" id="job_title" name="job_title" value="{{isset($oldInputs)? $oldInputs['job_title']: ''}}" class="form-control">
                        </div
>                            </div>
