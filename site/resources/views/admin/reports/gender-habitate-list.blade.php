...
<div class="card rtl">
    ...
    <div class="card-content">
        <div class="row">
            <form action="{{url('admin/reports/genders-habitate-list')}}" method="get">
                ...
                <div class="col-md-8 col-sm-8 pull-right">
                    <div class="col-md-9 col-sm-12">
                        <div class="form-group label-floating rtl col-lg-12 col-md-12">
                            <input type="text" id="city_title" name="city_title" value="{{isset($oldInputs)? $oldInputs['city_title']: ''}}" class="form-control">
                        </div
>                            </div>
