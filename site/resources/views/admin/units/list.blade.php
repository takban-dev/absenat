                        ...
                        <tbody>
                            @foreach ($units as $unit)
                                <tr>
                                    ...
                                    <td>{{ $unit->phone }}</td>
                                    <td><a href="{{ url( 'admin/unit/' . $unit->id) }}"><i class="fa fa-file" aria-hidden="true"></i></a></td>
                                    <!-- <td><a href="{{ url( 'admin/unit-remove/' . $unit->id) }}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td> -->
                                    <td><a onclick="remove({{$unit->id}}, '{{$unit->title}}')"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
