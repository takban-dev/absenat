                        ...
                        <thead>
                            ...
                            @foreach ($units as $unit)
                                <tr>
                                    ...
                                    <td>{{ $unit->phone }}</td>
                                    <td><a href="{{ url( 'unit/' . $unit->id) }}"><i class="fa fa-file" aria-hidden="true"></i></a></td>
                                    <td><a href="{{ url( 'unit-remove/' . $unit->id) }}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card rtl">
            ...
            <div class="card-content table-responsive" style="text-align: center;">
                <form action="{{url('unit-list-print/')}}" method="get" target="_blank">
